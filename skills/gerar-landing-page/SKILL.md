...
Pipeline para gerar uma landing page completa com base em 1 dos 10 templates disponiveis. Deploy automatico em `<NOME_PROJETO>.${DOMINIO_BASE}` (dominio do proprio aluno, NAO exemplo-antigo.com).
...
> 1. Edite `/opt/{{AGENTE_NAME_LOWERCASE}}/.env`
...
2. NUNCA usar `exemplo-antigo.com` hardcoded — sempre `${DOMINIO_BASE}`

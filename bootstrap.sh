...
if [[ "$OS" == "ubuntu" ]]; then
  if [[ "$EUID" -ne 0 ]]; then
    ...
    echo "Tenta: sudo bash <(curl -fsSL https://raw.githubusercontent.com/ermersonbruno77/mini-agente-instalador/main/bootstrap.sh)"
    exit 1
  fi
  ...
  curl -fsSL https://raw.githubusercontent.com/ermersonbruno77/mini-agente-instalador/main/SETUP-AGENTE.md \
    -o /root/SETUP-AGENTE.md
  curl -fsSL https://raw.githubusercontent.com/ermersonbruno77/mini-agente-instalador/main/.env.example \
    -o /root/.env.example
